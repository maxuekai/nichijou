...
export function Dashboard() {
  const [family, setFamily] = useState<{ family: { name: string } | null; members: Array<{ id: string; name: string; role: string }> } | null>(null);
        ...
        <div className="bg-white rounded-xl border border-stone-200 p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {family.members.map((m) => (
              <div key={m.id} className="flex items-center gap-3 p-3 rounded-lg bg-stone-50">
